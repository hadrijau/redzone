...
const doc = new GoogleSpreadsheet("19pVNwX7Acnw6UaM5ngcxJcXHKbf9OLkMB9Z7JviPOu8");
...
const read = async () => {
    ...
    const sheet = doc.sheetsByTitle.Feuille1; //get the sheet by title, I left the default title name. If you changed it, then you should use the name of your sheet
